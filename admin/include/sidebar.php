                ...
                <nav id="sidebarMenu" class="user-sidebar col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse h-100 position-fixed ">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item  my-3 d-flex flex-row  align-items-center ps-2">
                            <a class="nav-link active fs-6" aria-current="page" href="http://localhost/findMe/admin/overview_cand.php">
                        ...
                        <li class="nav-item  my-3 d-flex flex-row  align-items-center ps-2">
                            <a class="nav-link active fs-6" aria-current="page" href="http://localhost/findMe/admin/employee_job.php">
                        ...
                        <li class="nav-item  my-3 d-flex flex-row  align-items-center ps-2">
                            <a class="nav-link active fs-6" aria-current="page" href="http://localhost/findMe/admin/filterjob.php">
                            <i class="fa-solid fa-briefcase me-2"></i>
                                Filter jobs
                            </a>
                        </li>
                        ...
                        <li class="nav-item  my-3 mb-5 d-flex flex-row  align-items-center ps-2">
                            <a class="nav-link active fs-6" aria-current="page" href="http://localhost/findMe/admin/cv.php">
                        ...
                        <li class="nav-item  my-5 d-flex flex-row  align-items-center ps-2">
                            <a class="nav-link active fs-6 text-danger" aria-current="page" href="http://localhost/findMe/admin/logout.php?">
